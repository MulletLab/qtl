...
void prob_ft_exHet(double rf, int t, double *transpr, double *het)
{
  ...
  B_11 = transpr[0];   // transpr[0] == transpr[5]
  B_12 = transpr[1];   // transpr[1] == transpr[6]
  B_14 = transpr[2];   
  B_22 = transpr[3];
  B_23 = transpr[4];

  u = ((4 * h * B_12) + sqrt(((4 * h * B_12)*(4 * h * B_12))-(4*(2-h*(B_22 + B_23))*(-2*(B_11+B_14)))))/(2*(2-h*(B_22 + B_23)));   //(2 * h) / (2 - 2 * h);
