		   ...
		   double *tol, int *verbose, double *het)
{
  ...
  int cross_scheme[2];
  double **countmat, **probmat;
  warning("This is BCsFt code modified by RFM and SKT, the passable heterozygosity version (with d and u); this is in development, and should not be used for general purposes");
...
void prob_ft_exHet(double rf, int t, double *transpr, double *het)
{
  ...
  d2=R_pow(d,2.0);
  ht=R_pow(h,t);
  rmin12=R_pow((r-1.0),2.0);

  u=(2.0*h)/(2.0-2.0*h);

  d=2.0*(rmin12)+8.0*u*r*(1.0-r)+ 2.0*(r2)+ 2.0*(u2)*((rmin12)+(r2));

  B_11 = (1.0/2.0)*((4.0*r4*u2)/(d2 - 4.0*d*r2*u2 + 8.0*d*r*u2 - 4.0*d*u2 - 16.0*r3*u4 + 24.0*r2*u4 - 16.0*r*u4 + 4.0*u4) - (8.0*(h/2.0 - 1.0/2.0)*(- u*r2 + u*r))/(d - 4.0*r2*u2 - d*h + 2.0*h*u2 + 4.0*r*u2 - 2.0*u2 - 4.0*h*r*u2 + 4.0*h*r2*u2) + (2.0*rmin12*(- 2.0*r2*u2 + 4.0*r*u2 - 2.0*u2 + d))/(d2 - 4.0*d*r2*u2 + 8.0*d*r*u2 - 4.0*d*u2 - 16.0*r3*u4 + 24.0*r2*u4 - 16.0*r*u4 + 4.0*u4) + (4.0*ht*(- u*r2 + u*r))/(h*(4.0*r2*u2 - 4.0*r*u2 + 2.0*u2 - d*h)) - (d*R_pow((-(2.0*u2*(2.0*r - 1.0))/d),t))/(2.0*u2*(d + 4.0*r*u2 - 2.0*u2)) - (d*R_pow(((2.0*u2*(2.0*r2 - 2.0*r + 1.0))/d),t)*(16.0*r2*u2 - 16.0*r3*u2 + 8.0*r4*u2 - d*h - 8.0*r*u2 + 2.0*u2 - 4.0*d*r2*u + 2.0*d*h*r + 4.0*d*r*u - 2.0*d*h*r2 - 4.0*d*h*r*u + 4.0*d*h*r2*u))/(2.0*(- 4.0*r2*u2 + 4.0*r*u2 - 2.0*u2 + d)*(8.0*r4*u4 - 16.0*r3*u4 + 16.0*r2*u4 - 2.0*d*h*r2*u2 - 8.0*r*u4 + 2.0*d*h*r*u2 + 2.0*u4 - d*h*u2)));

  B_14 = (1.0/2.0)*((2.0*r2*(- 2.0*r2*u2 + 4.0*r*u2 - 2.0*u2 + d))/(d2 - 4.0*d*r2*u2 + 8.0*d*r*u2 - 4.0*d*u2 - 16.0*r3*u4 + 24.0*r2*u4 - 16.0*r*u4 + 4.0*u4) - (8.0*(h/2.0 - 1.0/2.0)*(- u*r2 + u*r))/(d - 4.0*r2*u2 - d*h + 2.0*h*u2 + 4.0*r*u2 - 2.0*u2 - 4.0*h*r*u2 + 4.0*h*r2*u2) + (4.0*ht*(- u*r2 + u*r))/(h*(4.0*r2*u2 - 4.0*r*u2 + 2.0*u2 - d*h)) + (d*R_pow((-(2.0*u2*(2.0*r - 1.0))/d),t))/(2.0*u2*(d + 4.0*r*u2 - 2.0*u2)) + (4.0*r2*u2*rmin12)/(d2 - 4.0*d*r2*u2 + 8.0*d*r*u2 - 4.0*d*u2 - 16.0*r3*u4 + 24.0*r2*u4 - 16.0*r*u4 + 4.0*u4) - (d*R_pow(((2.0*u2*(2.0*r2 - 2.0*r + 1.0))/d),t)*(16.0*r2*u2 - 16.0*r3*u2 + 8.0*r4*u2 - d*h - 8.0*r*u2 + 2.0*u2 - 4.0*d*r2*u + 2.0*d*h*r + 4.0*d*r*u - 2.0*d*h*r2 - 4.0*d*h*r*u + 4.0*d*h*r2*u))/(2.0*(- 4.0*r2*u2 + 4.0*r*u2 - 2.0*u2 + d)*(8.0*r4*u4 - 16.0*r3*u4 + 16.0*r2*u4 - 2.0*d*h*r2*u2 - 8.0*r*u4 + 2.0*d*h*r*u2 + 2.0*u4 - d*h*u2)));

  B_12 = (1.0/4.0)*( - (8.0*ht*r*u*(r - 1.0))/(h*(d*h + 4.0*r*u2 - 2.0*u2)) - (4.0*d*r*(r - 1.0)*R_pow((-(2.0*u2*(2.0*r - 1.0))/d),t))/(u*(2.0*r - 1.0)*(d*h + 4.0*r*u2 - 2.0*u2)));
