...
void prob_ft_exHet(double rf, int t, double *transpr, double *het)
{
  ...
  d=2*(rmin12)+8*u*r*(1-r)+ 2*(r2)+ 2*(u2)*((rmin12)+(r2));

  B_11 = (1/2)*((4*r4*u2)/(d2 - 4*d*r2*u2 + 8*d*r*u2 - 4*d*u2 - 16*r3*u4 + 24*r2*u4 - 16*r*u4 + 4*u4) - (8*(h/2 - 1/2)*(- u*r2 + u*r))/(d - 4*r2*u2 - d*h + 2*h*u2 + 4*r*u2 - 2*u2 - 4*h*r*u2 + 4*h*r2*u2) + (2*rmin12*(- 2*r2*u2 + 4*r*u2 - 2*u2 + d))/(d2 - 4*d*r2*u2 + 8*d*r*u2 - 4*d*u2 - 16*r3*u4 + 24*r2*u4 - 16*r*u4 + 4*u4) + (4*ht*(- u*r2 + u*r))/(h*(4*r2*u2 - 4*r*u2 + 2*u2 - d*h)) - (d*R_pow((-(2*u2*(2*r - 1))/d),t))/(2*u2*(d + 4*r*u2 - 2*u2)) - (d*R_pow(((2*u2*(2*r2 - 2*r + 1))/d),t)*(16*r2*u2 - 16*r3*u2 + 8*r4*u2 - d*h - 8*r*u2 + 2*u2 - 4*d*r2*u + 2*d*h*r + 4*d*r*u - 2*d*h*r2 - 4*d*h*r*u + 4*d*h*r2*u))/(2*(- 4*r2*u2 + 4*r*u2 - 2*u2 + d)*(8*r4*u4 - 16*r3*u4 + 16*r2*u4 - 2*d*h*r2*u2 - 8*r*u4 + 2*d*h*r*u2 + 2*u4 - d*h*u2)));

  B_14 = (1/2)*((2*r2*(- 2*r2*u2 + 4*r*u2 - 2*u2 + d))/(d2 - 4*d*r2*u2 + 8*d*r*u2 - 4*d*u2 - 16*r3*u4 + 24*r2*u4 - 16*r*u4 + 4*u4) - (8*(h/2 - 1/2)*(- u*r2 + u*r))/(d - 4*r2*u2 - d*h + 2*h*u2 + 4*r*u2 - 2*u2 - 4*h*r*u2 + 4*h*r2*u2) + (4*ht*(- u*r2 + u*r))/(h*(4*r2*u2 - 4*r*u2 + 2*u2 - d*h)) + (d*R_pow((-(2*u2*(2*r - 1))/d),t))/(2*u2*(d + 4*r*u2 - 2*u2)) + (4*r2*u2*rmin12)/(d2 - 4*d*r2*u2 + 8*d*r*u2 - 4*d*u2 - 16*r3*u4 + 24*r2*u4 - 16*r*u4 + 4*u4) - (d*R_pow(((2*u2*(2*r2 - 2*r + 1))/d),t)*(16*r2*u2 - 16*r3*u2 + 8*r4*u2 - d*h - 8*r*u2 + 2*u2 - 4*d*r2*u + 2*d*h*r + 4*d*r*u - 2*d*h*r2 - 4*d*h*r*u + 4*d*h*r2*u))/(2*(- 4*r2*u2 + 4*r*u2 - 2*u2 + d)*(8*r4*u4 - 16*r3*u4 + 16*r2*u4 - 2*d*h*r2*u2 - 8*r*u4 + 2*d*h*r*u2 + 2*u4 - d*h*u2)));

  B_12 = (1/4)*( - (8*ht*r*u*(r - 1))/(h*(d*h + 4*r*u2 - 2*u2)) - (4*d*r*(r - 1)*R_pow((-(2*u2*(2*r - 1))/d),t))/(u*(2*r - 1)*(d*h + 4*r*u2 - 2*u2)));

  B_22 = (d*R_pow(((2*u2*(2*r2 - 2*r + 1))/d),t))/(4*(2*r2*u2 - 2*r*u2 + u2)) - (d*R_pow((-(2*u2*(2*r - 1))/d),t))/(4*u2*(2*r - 1));

  B_23 = (d*R_pow(((2*u2*(2*r2 - 2*r + 1))/d),t))/(4*(2*r2*u2 - 2*r*u2 + u2)) + (d*R_pow((-(2*u2*(2*r - 1))/d),t))/(4*u2*(2*r - 1));
